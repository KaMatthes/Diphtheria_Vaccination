...
data_cases <- data_Total %>%
  ...
  mutate(n_year = 1,
         ...
         Year_gr = ifelse(Year_gr>=1969 & Year_gr < 1975, "1969-1974", Year_gr),
...
data_fat <- data_fatality   %>%
  ...
  mutate(`Case fatality rate (95% CI)` = recode(`Case fatality rate (95% CI)`, 
                                                ...
                                                "0 (0-13.32)" = "-",
                                                "0 (0-2.89)" = "-")) %>%
  mutate(`Case fatality rate (95% CI)` = ifelse(Year > "1945-1949", "-", `Case fatality rate (95% CI)`))
